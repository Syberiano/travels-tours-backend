...
INSERT INTO packages (name, description, price, destination, duration_days, max_participants, itinerary, status, average_rating, created_at, updated_at, approved_at) VALUES
('París: Romance y Cultura', 'Disfruta 7 días en la ciudad del amor con visitas a la Torre Eiffel, Louvre y Versalles', 1500.00, 'París, Francia', 7, 40, 'Día 1: Llegada e instalación. Día 2: Torre Eiffel y Crucero Sena. Día 3-5: Museos y Palacios...', 'APPROVED', 4.8, NOW(), NOW(), NOW()),
('Cancún: Playas Paradisíacas', 'Relájate 5 días en las mejores playas de Cancún con opciones de buceo y snorkel', 1200.00, 'Cancún, México', 5, 35, 'Incluye hotel 5 estrellas, transporte, y tours acuáticos', 'APPROVED', 4.6, NOW(), NOW(), NOW()),
('Tokio: Tradición Futura', 'Explora 10 días la mezcla de tradición y modernidad en Japón', 2000.00, 'Tokio, Japón', 10, 50, 'Templos, tecnología y gastronomía japonesa', 'PENDING', 0.0, NOW(), NOW(), NULL);
